        ...
        <div class="main-panel">
            ...
            @if(session()->has('message'))
                ...
                <div class="div_center">
                    <h1 class = 'font_size'>Thêm Tài Khoản Quản Trị<h2>

                    <form action="{{url('/add_acc')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="div_design">
                    ...
                    <input class="text_color" type="text" name="name" placeholder="Điền tên người dùng" required>
                    ...
                    <label>Email :</label>
                    <input class="text_color" type="email" name="email" placeholder="Điền email" required>
                    ...
                    <input type="submit" value ="Thêm tài khoản" class ="btn btn-warning">
